...
function DepositSuccessContent() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-bg-light px-4">
      ...
      <h1 className="mb-2 text-center font-cairo text-2xl font-bold text-text-primary">تم الإيداع بنجاح!</h1>
      <p className="mb-6 text-center font-manrope text-4xl font-bold text-success">
      ...
      <div className="mb-8 w-full rounded-2xl bg-bg-card p-6 shadow-md">
        {[
          ...
          ['الرصيد الجديد', `${parseFloat(newBalance).toLocaleString('en')} ج.م`],
...
export default function DepositSuccessPage() {
  return <Suspense><DepositSuccessContent /></Suspense>;
}
